...
# Main class517_by_517_centre_534578.png
MAIN_CLASS = serialAbelianSandpile.ParallelSimulation

# Default arguments (update these if needed)
ARGS ?= input/65_by_65_all_4.csv output/8_by_8_all_4copy.png    # Replace 'default_arguments' with your specific default arguments, if any
